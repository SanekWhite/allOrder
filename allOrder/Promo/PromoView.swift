...
class PromoView: UIView {
    ...
    var onSwitchToggle: ((Bool, PromoViewModel.Promocode) -> Void)?
    ...
    private func setupView() {
        ...
        promoCode1Switch.isOn = promo.promocodes[0].active
    ...
    @objc func promoCode1SwitchToggled(_ sender: UISwitch) {
        ...
        if let promoCode = promo.promocodes.first {
                   onSwitchToggle?(sender.isOn, promoCode)
        } 
